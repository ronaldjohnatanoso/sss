...
while True:
    ...
    if iter_num % log_interval == 0 and master_process and device_type == 'cuda':
        ...
        print(f"GPU Memory before iteration {iter_num}:")
    ...
    if iter_num % log_interval == 0 and master_process:
        ...
        print(f"Time stamp: {time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(current_time))}, Time since last checkpoint: {formatted_time_since_last_checkpoint}")
